...
var Vt = (t, e) => {
	for (var r in e) Wn(t, r, {
		get: e[r],
		enumerable: !0
	});
}, bf = (t, e, r, n) => {
	if (e && typeof e == "object" || typeof e == "function") for (let o of hf(e)) !gf.call(t, o) && o !== r && Wn(t, o, {
		get: () => e[o],
		enumerable: !(n = ff(e, o)) || n.enumerable
	});
	return t;
};
var Xt = (t) => bf(Wn({}, "__esModule", { value: !0 }), t);
var xr, Et, kt, yf, Oa, Hn = V(() => {
	"use strict";
	xr = /* @__PURE__ */ new Map(), Et = [], kt = (t, e, r) => {
		if (e && typeof e.init == "function" && typeof e.createInferenceSessionHandler == "function") {
			let n = xr.get(t);
			if (n === void 0) xr.set(t, {
				backend: e,
				priority: r
			});
			else {
		...
		if (e.aborted) return e.error;
		{
			let r = !!e.initPromise;
			try {
				return r || (e.initPromise = e.backend.init(t)), await e.initPromise, e.initialized = !0, e.backend;
			} catch (n) {
				return r || (e.error = `${n}`, e.aborted = !0), e.error;
			} finally {
...
var Ma, Oe, Fn = V(() => {
	...
	Object.defineProperty(Oe, "logLevel", { enumerable: !0 });
});
var _e, Ra = V(() => {
	"use strict";
	Fn();
	...
	Ua = (t, e) => {
		...
		if (r != null) {
			...
			d === void 0 || d.mean === void 0 ? c = [
				...
				d.mean[2],
				255
			], d.mean[3] !== void 0 && (c[3] = d.mean[3])), d === void 0 || d.bias === void 0 ? p = [
				0,
				0,
				0,
				0
...
var qn, La, Wa, Ga, Ha, Fa, qa = V(() => {
	...
	qn = (t, e) => {
		...
		let { height: r, width: n } = e, o = e.norm ?? {
			mean: 255,
			bias: 0
		}, i, s;
		...
		return d === "RGBA" ? new Be("float32", p, [
			1,
			4,
			r,
			n
		...
		let { width: r, height: n, download: o, dispose: i } = e;
		return new Be({
			location: "texture",
			type: "float32",
			texture: t,
...
var Qa, Ya, Xa = V(() => {
	...
	Qa = (t) => {
		...
		switch (t.location) {
			case "cpu": return new Be(t.type, t.data, e);
			case "cpu-pinned": return new Be({
				location: "cpu-pinned",
				data: t.data,
				type: t.type,
				dims: e
			});
			case "texture": return new Be({
				location: "texture",
				texture: t.texture,
				type: t.type,
				dims: e
			});
			case "gpu-buffer": return new Be({
				location: "gpu-buffer",
				gpuBuffer: t.gpuBuffer,
				type: t.type,
				dims: e
			});
			case "ml-tensor": return new Be({
				location: "ml-tensor",
				mlTensor: t.mlTensor,
				type: t.type,
				dims: e
			});
			default: throw new Error(`tensorReshape: tensor location ${t.location} is not supported`);
		}
	};
});
var Be, Sr = V(() => {
		...
		async run(e, r, n) {
			...
			if (typeof r == "object") {
				...
				if (Array.isArray(r)) {
					...
					let c = !1, p = Object.getOwnPropertyNames(r);
					for (let m of this.outputNames) if (p.indexOf(m) !== -1) {
						let g = r[m];
						(g === null || g instanceof je) && (c = !0, s = !1, o[m] = g);
					}
					if (c) {
						if (typeof n == "object" && n !== null) i = n;
						else if (typeof n < "u") throw new TypeError("'options' must be an object.");
...
`));
	...
	if (r || n) {
		...
		n && (d = (a) => {
			...
			return l.open("GET", a, !1), l.responseType = "arraybuffer", l.send(null), new Uint8Array(l.response);
		}), u = async (a) => {
	...
	var g, y, b, _, T, x, $ = console.log.bind(console), S = console.error.bind(console), I = $, E = S, A = !1, z = (a) => a.startsWith("file://");
	function v() {
		...
		let a = function(l) {
			try {
				...
				if (f === "load") {
					...
					})(h.Rc), Dn(h.Rc, 0, 0, 1, 0, 0), Go(), In(h.Rc), R || (Mi(), R = !0);
					try {
						np(h.Md, h.bd);
					} catch (w) {
						if (w != "unwind") throw w;
	...
	var N, F, q, X, D, L, Q, Y, Z, te, ae, le = !1;
	function Me() {
		var a = ht.buffer;
	...
	function M(a) {
		throw E(a = "Aborted(" + a + ")"), A = !0, a = new WebAssembly.RuntimeError(a + ". Build with -sASSERTIONS for more info."), T?.(a), a;
	}
	function G() {
		return { a: {
			ma: Am,
	...
	async function be() {
		...
		}) : o ? a(new WebAssembly.Instance(y, G()), y) : (ae ??= e.locateFile ? e.locateFile ? e.locateFile("ort-wasm-simd-threaded.jsep.wasm", m) : m + "ort-wasm-simd-threaded.jsep.wasm" : new URL("../../onnxruntime-web/dist/ort-wasm-simd-threaded.jsep.wasm", import.meta.url).href, l = await async function(f) {
			var w = ae;
			if (!g && !z(w)) try {
	...
	var Ho = (a) => new Promise((l) => {
		a.onmessage = (w) => {
			...
			if (w = C.Sc, C.Zc && C.Zc != vr()) {
				...
				Wo(It[C.Nd]);
			}) : w === "loaded" ? (a.loaded = !0, l(a)) : C.target === "setimmediate" ? a.postMessage(C) : w === "uncaughtException" ? a.onerror(C.error) : w === "callHandler" ? e[C.wd](...C.args) : w && E(`worker sent an unknown command ${w}`);
		}, a.onerror = (w) => {
	...
	function op(a) {
		var l = new wn(a >>>= 0);
		return (v(), N)[l.Tc + 12 >>> 0] == 0 && (qo(l, !0), pr--), Ko(l, !1), cr.push(l), Fi(a);
	}
	var Ut = 0, ip = () => {
		ce(0, 0);
		var a = cr.pop();
	...
	var dp = () => {
		...
		var l = a.cd;
		throw (v(), N)[a.Tc + 13 >>> 0] == 0 && (cr.push(a), Ko(a, !0), qo(a, !1), pr++), Rn(l), Ut = l;
	};
	function lp(a, l, h) {
		var f = new wn(a >>>= 0);
	...
	function Zo(a, l, h, f) {
		...
		var w = [];
		return o && w.length === 0 ? jo(a, l, h, f) : (a = {
			Ld: h,
			Rc: a,
			bd: f,
			rd: w
		}, o ? (a.Sc = "spawnThread", postMessage(a, w), 0) : qe(a));
	}
	function pp(a) {
		throw Ut ||= a >>> 0, Ut;
	}
	...
	var pi = (a, l, h) => {
		switch (l) {
			case 1: return h ? (f) => (v(), N)[f >>> 0] : (f) => (v(), F)[f >>> 0];
			case 2: return h ? (f) => (v(), q)[f >>> 1 >>> 0] : (f) => (v(), X)[f >>> 1 >>> 0];
			case 4: return h ? (f) => (v(), D)[f >>> 2 >>> 0] : (f) => (v(), L)[f >>> 2 >>> 0];
			case 8: return h ? (f) => (v(), Z)[f >>> 3 >>> 0] : (f) => (v(), te)[f >>> 3 >>> 0];
			default: throw new TypeError(`invalid integer width (${l}): ${a}`);
		}
	};
	function hp(a, l, h, f, w) {
		...
		lt(a, {
			name: l,
			Oc: C,
			Vc: (P, B) => (typeof B == "number" && (B = BigInt(B)), B),
			Uc: pi(l, h, !f),
			Wc: null
		});
	}
	...
	var _p = (a, l) => {
		switch (l) {
			case 4: return function(h) {
				return this.Oc((v(), Q)[h >>> 2 >>> 0]);
			};
			case 8: return function(h) {
				return this.Oc((v(), Y)[h >>> 3 >>> 0]);
			};
			default: throw new TypeError(`invalid float width (${l}): ${a}`);
		}
	};
	function wp(a, l, h) {
		h >>>= 0, lt(a >>>= 0, {
	...
	function Dp(a, l) {
		(a >>>= 0) == l >>> 0 ? setTimeout(hr) : o ? postMessage({
			Zc: a,
			Sc: "checkMailbox"
	...
	var bt = 0, et = null, hi = 0, br = [], An = /* @__PURE__ */ new Map(), gi = /* @__PURE__ */ new Map(), bi = /* @__PURE__ */ new Map(), Vp = 0, En = null, Lp = [], yi = (a) => function(l) {
		if (!A) {
			if (bt === 0) {
				...
				l((w = 0) => {
					if (!A && (hi = w, h = !0, f)) {
						bt = 2, gr(() => ka(et)), typeof MainLoop < "u" && MainLoop.ud && MainLoop.resume(), w = !1;
						try {
							var C = function() {
								var H = (v(), D)[et + 8 >>> 2 >>> 0];
						...
						if (!et) {
							var B = En;
							B && (En = null, (w ? B.reject : B.resolve)(C), P = !0);
						}
						if (w && !P) throw C;
					}
				}), f = !0, h || (bt = 1, et = function() {
	...
	function Kp(a, l, h) {
		...
		switch (a = C.map((H, K) => {
			...
			case 3:
				B = "";
				break;
			case 1: P.getStringOrSymbol = yr, B = "toValue(handle)[getStringOrSymbol(methodName)]";
		}
  ...
  ${B}
	...
	function am(a, l) {
		a = -9007199254740992 > a || 9007199254740992 < a ? NaN : Number(a), l >>>= 0, a = /* @__PURE__ */ new Date(1e3 * a), (v(), D)[l >>> 2 >>> 0] = a.getUTCSeconds(), (v(), D)[l + 4 >>> 2 >>> 0] = a.getUTCMinutes(), (v(), D)[l + 8 >>> 2 >>> 0] = a.getUTCHours(), (v(), D)[l + 12 >>> 2 >>> 0] = a.getUTCDate(), (v(), D)[l + 16 >>> 2 >>> 0] = a.getUTCMonth(), (v(), D)[l + 20 >>> 2 >>> 0] = a.getUTCFullYear() - 1900, (v(), D)[l + 24 >>> 2 >>> 0] = a.getUTCDay(), a = (a.getTime() - Date.UTC(a.getUTCFullYear(), 0, 1, 0, 0, 0, 0)) / 864e5 | 0, (v(), D)[l + 28 >>> 2 >>> 0] = a;
	}
	var wi = (a) => a % 4 == 0 && (a % 100 != 0 || a % 400 == 0), vi = [
		0,
		31,
		60,
		91,
	...
	function sm(a, l) {
		a = -9007199254740992 > a || 9007199254740992 < a ? NaN : Number(a), l >>>= 0, a = /* @__PURE__ */ new Date(1e3 * a), (v(), D)[l >>> 2 >>> 0] = a.getSeconds(), (v(), D)[l + 4 >>> 2 >>> 0] = a.getMinutes(), (v(), D)[l + 8 >>> 2 >>> 0] = a.getHours(), (v(), D)[l + 12 >>> 2 >>> 0] = a.getDate(), (v(), D)[l + 16 >>> 2 >>> 0] = a.getMonth(), (v(), D)[l + 20 >>> 2 >>> 0] = a.getFullYear() - 1900, (v(), D)[l + 24 >>> 2 >>> 0] = a.getDay();
...
`))[0] == "Error" && f.shift(), Ci(f);
	...
	function Ei(a, l) {
		...
		for (h of Ai()) {
			var C = l + f;
			(v(), L)[a + w >>> 2 >>> 0] = C, f += gt(h, C, Infinity) + 1, w += 4;
		}
		return 0;
	}
	function ki(a, l) {
	...
	o || function() {
	...
	}(), o || (ht = new WebAssembly.Memory({
		initial: 256,
		maximum: 65536,
		shared: !0
	}), Me()), e.wasmBinary && (g = e.wasmBinary), e.stackSave = () => de(), e.stackRestore = (a) => ue(a), e.stackAlloc = (a) => Mn(a), e.setValue = function(a, l, h = "i8") {
		switch (h.endsWith("*") && (h = "*"), h) {
			...
			case "*":
				(v(), L)[a >>> 2 >>> 0] = l;
				break;
			default: M(`invalid type for setValue: ${h}`);
		}
	}, e.getValue = function(a, l = "i8") {
		switch (l.endsWith("*") && (l = "*"), l) {
			case "i1":
			case "i8": return (v(), N)[a >>> 0];
			case "i16": return (v(), q)[a >>> 1 >>> 0];
			case "i32": return (v(), D)[a >>> 2 >>> 0];
			case "i64": return (v(), Z)[a >>> 3 >>> 0];
			case "float": return (v(), Q)[a >>> 2 >>> 0];
			case "double": return (v(), Y)[a >>> 3 >>> 0];
			case "*": return (v(), L)[a >>> 2 >>> 0];
			default: M(`invalid type for getValue: ${l}`);
		}
	}, e.UTF8ToString = Ae, e.stringToUTF8 = gt, e.lengthBytesUTF8 = mr;
	var Bi, Mi, vr, tt, Qt, Dn, Ri, Ui, Ni, Bn, Vi, Li, ce, Yt, Wi, ue, Mn, de, Gi, Rn, Hi, Fi, qi, Un, Ki, ji, Zi, Qi, Yi, Xi, Ji, ea, ta, ra, na, oa, ia, aa, sa, ua, da, la, ca, pa, ma, fa, ha, ga, ba, ya, _a, wa, va, $a, xa, Sa, Ta, Ia, Ca, Aa, Ea, ka, Pa, ct, Im = [
		lr,
		Vo,
		jo,
		Jo,
		...
		974297: (a) => e.Ed(a),
		974329: (a, l, h) => {
			e.ed(Number(a), Number(l), Number(h), !0);
		},
		974392: (a, l, h) => {
			e.ed(Number(a), Number(l), Number(h));
		},
		974449: () => typeof wasmOffsetConverter < "u",
		974506: (a) => {
			e.$b("Abs", a, void 0);
		},
		974557: (a) => {
		...
		976796: (a, l, h, f, w) => {
			e.$b("ReduceMean", a, {
				keepDims: !!l,
				noopWithEmptyAxes: !!h,
				axes: f ? Array.from((v(), D).subarray(Number(f) >>> 0, Number(w) >>> 0)) : []
			});
		},
		976971: (a, l, h, f, w) => {
			e.$b("ReduceMax", a, {
		...
		978994: (a, l, h, f, w, C, P, B, H, K, se, pe, xe, Ie, yt) => {
			e.$b("ConvTranspose", a, {
				...
				strides: [B],
				wIsConst: () => !!(v(), N)[K >>> 0],
				outputPadding: se ? Array.from((v(), D).subarray(Number(se) >>> 0, Number(pe) >>> 0)) : [],
				outputShape: xe ? Array.from((v(), D).subarray(Number(xe) >>> 0, Number(Ie) >>> 0)) : [],
				activation: Ae(yt)
			});
		},
		979427: (a, l, h, f, w, C, P, B, H, K, se, pe, xe, Ie) => {
			e.$b("ConvTranspose", a, {
				format: B ? "NHWC" : "NCHW",
				autoPad: l,
				dilations: Array.from((v(), D).subarray(Number(h) >>> 0, 2 + (Number(h) >>> 0) >>> 0)),
				group: f,
				kernelShape: Array.from((v(), D).subarray(Number(w) >>> 0, 2 + (Number(w) >>> 0) >>> 0)),
				pads: Array.from((v(), D).subarray(Number(C) >>> 0, 4 + (Number(C) >>> 0) >>> 0)),
				strides: Array.from((v(), D).subarray(Number(P) >>> 0, 2 + (Number(P) >>> 0) >>> 0)),
				wIsConst: () => !!(v(), N)[H >>> 0],
				outputPadding: K ? Array.from((v(), D).subarray(Number(K) >>> 0, Number(se) >>> 0)) : [],
				outputShape: pe ? Array.from((v(), D).subarray(Number(pe) >>> 0, Number(xe) >>> 0)) : [],
				activation: Ae(Ie)
			});
		},
		...
		981273: (a, l, h, f, w, C, P, B, H, K, se, pe, xe, Ie) => {
			e.$b("AveragePool", a, {
				...
				count_include_pad: f,
				storage_order: w,
				dilations: C ? Array.from((v(), D).subarray(Number(C) >>> 0, Number(P) >>> 0)) : [],
				kernel_shape: B ? Array.from((v(), D).subarray(Number(B) >>> 0, Number(H) >>> 0)) : [],
				pads: K ? Array.from((v(), D).subarray(Number(K) >>> 0, Number(se) >>> 0)) : [],
				strides: pe ? Array.from((v(), D).subarray(Number(pe) >>> 0, Number(xe) >>> 0)) : []
			});
		},
		981752: (a, l) => {
			e.$b("GlobalAveragePool", a, { format: l ? "NHWC" : "NCHW" });
		...
		983943: (a, l, h, f, w) => {
			e.$b("Split", a, {
				axis: l,
				numOutputs: h,
				splitSizes: f ? Array.from((v(), D).subarray(Number(f) >>> 0, Number(w) >>> 0)) : []
			});
		},
		984099: (a) => {
			e.$b("Expand", a, void 0);
		...
		984382: (a, l, h, f, w, C, P, B, H, K, se) => {
			e.$b("Resize", a, {
				antialias: l,
				axes: h ? Array.from((v(), D).subarray(Number(h) >>> 0, Number(f) >>> 0)) : [],
				coordinateTransformMode: Ae(w),
				cubicCoeffA: C,
				excludeOutside: P,
				extrapolationValue: B,
				keepAspectRatioPolicy: Ae(H),
				mode: Ae(K),
				nearestMode: Ae(se)
			});
		},
		984744: (a, l, h, f, w, C, P) => {
			e.$b("Slice", a, {
				starts: l ? Array.from((v(), D).subarray(Number(l) >>> 0, Number(h) >>> 0)) : [],
				ends: f ? Array.from((v(), D).subarray(Number(f) >>> 0, Number(w) >>> 0)) : [],
				axes: C ? Array.from((v(), D).subarray(Number(C) >>> 0, Number(P) >>> 0)) : []
			});
		},
		985008: (a) => {
			e.$b("Tile", a, void 0);
		...
		985422: (a, l, h, f, w) => {
			e.$b("Pad", a, {
				mode: l,
				value: h,
				pads: f ? Array.from((v(), D).subarray(Number(f) >>> 0, Number(w) >>> 0)) : []
			});
		},
		985565: (a, l, h, f, w, C) => {
			e.$b("BatchNormalization", a, {
				epsilon: l,
				momentum: h,
				spatial: !!w,
				trainingMode: !!f,
		...
		986515: (a, l, h, f, w, C, P, B, H) => {
			e.$b("Attention", a, {
				...
				scale: w,
				doRotary: C,
				qkvHiddenSizes: P ? Array.from((v(), D).subarray(Number(B) >>> 0, Number(B) + P >>> 0)) : [],
				pastPresentShareBuffer: !!H
			});
		},
		986787: (a) => {
		...
		986959: (a, l, h, f, w, C, P, B, H, K, se, pe, xe, Ie, yt, Vn) => {
			e.$b("Conv", a, {
				format: pe ? "NHWC" : "NCHW",
				auto_pad: l,
				dilations: h ? Array.from((v(), D).subarray(Number(h) >>> 0, Number(f) >>> 0)) : [],
				group: w,
				kernel_shape: C ? Array.from((v(), D).subarray(Number(C) >>> 0, Number(P) >>> 0)) : [],
				pads: B ? Array.from((v(), D).subarray(Number(B) >>> 0, Number(H) >>> 0)) : [],
				strides: K ? Array.from((v(), D).subarray(Number(K) >>> 0, Number(se) >>> 0)) : [],
				w_is_const: () => !!(v(), N)[Number(xe) >>> 0],
				activation: Ae(Ie),
				activation_params: yt ? Array.from((v(), Q).subarray(Number(yt) >>> 0, Number(Vn) >>> 0)) : []
			});
		},
		987543: (a) => {
			e.$b("Gelu", a, void 0);
		...
		988384: (a, l, h, f, w) => {
			e.$b("RotaryEmbedding", a, {
				interleaved: !!l,
				numHeads: h,
				rotaryEmbeddingDim: f,
				scale: w
			});
		},
		988523: (a, l, h) => {
			e.$b("SkipLayerNormalization", a, {
				epsilon: l,
				simplified: !!h
			});
		},
	...
	function $r() {
		if (0 < he) Te = $r;
			...
			0 < he ? Te = $r : (e.calledRun = !0, A || (ve(), _?.(e)));
		}
	}
...
var gs, Xn, xf, We, bs, Yn, Sf, Tf, ys, If, fs, _s, hs, ws, Ar = V(() => {
	"use strict";
	Cr();
	gs = typeof location > "u" ? void 0 : location.origin, Xn = import.meta.url > "file:" && import.meta.url < "file;", xf = () => {
		if (Xn) return new URL(new URL("ort.bundle.min.mjs", import.meta.url).href, gs).href;
...
var Jn, eo, Rr, vs, Cf, Af, Ef, Er, ye, vt = V(() => {
	"use strict";
	Ar();
	eo = !1, Rr = !1, vs = !1, Cf = () => {
		...
		let o = t.wasmPaths, i = typeof o == "string" ? o : void 0, s = o?.mjs, u = s?.href ?? s, d = o?.wasm, c = d?.href ?? d, p = t.wasmBinary, [m, g] = await ws(u, i, r > 1, !!p || !!c), y = !1, b = [];
		if (e > 0 && b.push(new Promise((_) => {
			...
			g(x).then(($) => {
				Rr = !1, eo = !0, Jn = $, _(), m && URL.revokeObjectURL(m);
			}, ($) => {
				Rr = !1, vs = !0, T($);
			});
...
var $s, xs = V(() => {
	...
	$s = (t) => {
		...
		try {
			...
			t?.terminate === void 0 && (o.terminate = !1);
			let i = 0;
...
var kf, Pf, Of, Lt, zf, Ss, Ts = V(() => {
	...
	kf = (t) => {
		switch (t) {
			...
			case "all": return 99;
			default: throw new Error(`unsupported graph optimization level: ${t}`);
		}
	}, Pf = (t) => {
		switch (t) {
			case "sequential": return 0;
			case "parallel": return 1;
			default: throw new Error(`unsupported execution mode: ${t}`);
		}
	}, Of = (t) => {
		t.extra || (t.extra = {}), t.extra.session || (t.extra.session = {});
		let e = t.extra.session;
		e.use_ort_model_bytes_directly || (e.use_ort_model_bytes_directly = "1"), t.executionProviders && t.executionProviders.some((r) => (typeof r == "string" ? r : r.name) === "webgpu") && (t.enableMemPattern = !1);
	}, Lt = (t, e, r, n) => {
...
var $t, rt, xt, Wt, rr, Nr, Vr, to, J = V(() => {
	"use strict";
	$t = (t) => {
		switch (t) {
			case "int8": return 3;
			...
			default: throw new Error(`unsupported data type: ${t}`);
		}
	}, rt = (t) => {
		switch (t) {
			case 3: return "int8";
		...
		let r = [
			...
			.5,
			.5
		][t], n = typeof e == "number" ? e : e.reduce((o, i) => o * i, 1);
		...
		switch (t) {
			...
			case "error": return 3;
			case "fatal": return 4;
			default: throw new Error(`unsupported logging level: ${t}`);
		}
		...
		switch (t) {
			...
			default: throw new Error(`unsupported data location: ${t}`);
		}
	};
});
var nr, ro = V(() => {
...
var Df, Bf, Is, Cs, Lr, Mf, ie, nt = V(() => {
	...
	Df = [
		...
		let r = rr(t);
		r >= rr(Is) && Bf(r, typeof e == "function" ? e() : e);
	}, ie = (...t) => {
		Cs && Mf(...t);
	};
});
var no, ot, k, zt, Wr, As, Es, re = V(() => {
	"use strict";
	no = class {
		...
		static isValidBroadcast(e, r) {
			...
			if (n > o) return !1;
			for (let i = 1; i <= n; i++) if (e[n - i] !== 1 && e[n - i] !== r[o - i]) return !1;
			return !0;
		}
	}, k = class t {
		static size(e) {
		...
		static areEqual(e, r) {
			return e.length !== r.length ? !1 : e.every((n, o) => n === r[o]);
		}
	}, zt = class t {
		...
		static computeConvOutputShape(e, r, n, o, i, s, u) {
			...
			let d = [e[0], r[0]];
			return t.computeShapeHelper(!1, e, d, n, o, i, s, u), d;
		}
		...
		static adjustPadAndReturnShape(e, r, n, o, i, s, u, d) {
			...
			if (d && d !== "NOTSET") switch (d) {
				case "VALID": return i[s] = 0, i[u] = 0, Math.floor((e - c) / r + 1);
				case "SAME_LOWER":
				case "SAME_UPPER":
...
var Ps, ao, Os, Rf, ks, Uf, zs, Hr, Fr, io, Ds, Bs = V(() => {
	"use strict";
	J();
	nt();
	Ps = new Map([
		...
		switch (e) {
			...
			default: throw new Error(`Unsupported data conversion from ${e} to 'int32'`);
		}
	}, Os = (t, e) => {
		if (e === "int32") return t;
		...
		switch (e) {
			...
			default: throw new Error(`Unsupported data conversion from 'int32' to ${e}`);
		}
	}, Rf = 1, ks = () => Rf++, Uf = new Map([
		["int8", "int32"],
		["uint8", "int32"],
		["uint32", "int32"],
		["int64", "int32"]
		...
		async ensureTensor(e, r, n, o) {
			...
			return this.wrapper = await this.tensorManager.getCachedTensor(e, r, n, d, !0, !0, u), o && this.activeUpload && (this.wrapper.write(this.activeUpload), this.activeUpload = void 0), this.wrapper.tensor;
		}
		upload(e) {
			let r = e;
			if (this.wrapper) {
				if (this.wrapper.fallbackType) if (this.wrapper.fallbackType === "int32") r = ao(e, this.wrapper.type), this.wrapper.setIsDataConverted(!0);
		...
		registerTensor(e, r, n, o) {
			let i = this.getMLContext(e), s = ks(), u = new Hr({
				sessionId: e,
				context: i,
				tensor: r,
				dataType: n,
...
var qr, Nf, Kr, Ms = V(() => {
	...
	qr = new Map([
		...
		async createTemporaryTensor(e, r, n) {
			...
			await this.tensorManager.ensureTensor(e, i, o, n, !1);
		...
		registerMLConstant(e, r, n, o, i, s, u = !1) {
			...
			switch (i.dataType) {
				...
				case "uint8":
					m = new Uint8Array(p);
					break;
				default: throw new Error(`Unsupported data type: ${i.dataType} in creating WebNN Constant from external data.`);
			}
		...
		isGraphInput(e, r) {
			...
			return n ? n.includes(r) : !1;
		}
		isGraphOutput(e, r) {
			let n = this.sessionGraphOutputs.get(e);
			return n ? n.includes(r) : !1;
		}
		isGraphInputOutputTypeSupported(e, r, n = !0) {
			let o = qr.get($t(r)), i = this.mlOpSupportLimitsBySessionId.get(e);
			return typeof o > "u" ? !1 : n ? !!i?.input.dataTypes.includes(o) : !!i?.output.dataTypes.includes(o);
		}
		flush() {}
	};
});
...
var Rs, so, uo, Vf, Lf, Us, co, lo, Vs, Ls = V(() => {
	"use strict";
	nt();
	jr();
	Rs = new Map([
		...
		[134217728, 6],
		[167772160, 6]
	]), so = [], uo = (t) => Math.ceil(Number(t) / 16) * 16, Vf = (t) => {
		...
		let o = uo(r), i = t.device.createBuffer({
			size: o,
		...
		registerExternalBuffer(e, r, n) {
			...
			return this.storageCache.set(o, {
				...
				originalSize: r
			}), ie("verbose", () => `[WebGPU] GpuDataManager.registerExternalBuffer(size=${r}) => id=${o}, registered.`), o;
		}
		...
		create(e, r = GPUBufferUsage.STORAGE | GPUBufferUsage.COPY_SRC | GPUBufferUsage.COPY_DST) {
			...
			}), ie("verbose", () => `[WebGPU] GpuDataManager.create(size=${e}) => id=${u.id}`), u;
		}
		get(e) {
...
var Dt, fo, we, ze, W, fe, ho, Bt, Ze, j, Zr, O, U, Ws, Qr, mo, Gs, oe = V(() => {
	"use strict";
	J();
	re();
	Dt = 64, fo = (t, e) => {
		...
		switch (Number(t)) {
			case 10: return e > 1 ? `vec${e}<f16>` : "f16";
			case 1: return e > 1 ? `vec${e}<f32>` : "f32";
			case 6: return e > 1 ? `vec${e}<i32>` : "i32";
			case 12: return e > 1 ? `vec${e}<u32>` : "u32";
			case 7:
		...
		let i = typeof r == "number", s = i ? r : r.length, u = [...new Array(s).keys()], d = s < 2 ? "u32" : s <= 4 ? `vec${s}<u32>` : `array<u32, ${s}>`, c = fo(e, o), p = typeof c == "string" ? c : c[1], g = {
			indices: d,
			value: p,
			storage: typeof c == "string" ? c : c[0],
			tensor: e
		}, y = (M) => typeof M == "string" ? M : `${M}u`, b = {
			offsetToIndices: !1,
			indicesToOffset: !1,
			...
			get: !1,
			getByIndices: !1
		}, _ = i ? "uniforms." : "", T = `${_}${t}_shape`, x = `${_}${t}_strides`, $ = "";
		for (let M = 0; M < s - 1; M++) $ += `
  ...
  fn o2i_${t}(offset: u32) -> ${g.indices} {
    ...
    ${$}
    return indices;
  }`, I = (M) => (b.offsetToIndices = !0, s < 2 ? M : `o2i_${t}(${M})`), E = [];
		if (s >= 2) for (let M = s - 1; M >= 0; M--) E.push(`${j(x, M, s)} * (indices[${M}])`);
		let A = s < 2 ? "" : `
  fn i2o_${t}(indices: ${g.indices}) -> u32 {
    return ${E.join("+")};
  }`, z = (M) => (b.indicesToOffset = !0, s < 2 ? M : `i2o_${t}(${M})`), v = (...M) => s === 0 ? "0u" : `${g.indices}(${M.map(y).join(",")})`, R = (M, G) => s < 2 ? `${M}` : `${j(M, G, s)}`, N = (M, G, be) => s < 2 ? `${M}=${be};` : `${j(M, G, s)}=${be};`, F = {}, q = (M, G) => {
  ...
  fn get_${t}ByIndices(indices: ${g.indices}) -> ${p} {
    return ${D(`i2o_${t}(indices)`)};
			...
			return `
  fn get_${t}(${u.map((be) => `d${be}: u32`).join(", ")}) -> ${p} {
    return get_${t}ByIndices(${v(u.map((be) => `d${be}`).join(", "))});
  }`;
		})(), Y = (...M) => {
			if (M.length !== s) throw new Error(`indices length must be ${s}`);
			let G = M.map(y).join(",");
			return s === 0 ? D("0u") : s === 1 ? D(G[0]) : (b.get = !0, b.getByIndices = !0, b.indicesToOffset = !0, `get_${t}(${G})`);
		}, Z = (M) => s < 2 ? D(M) : (b.getByIndices = !0, b.indicesToOffset = !0, `get_${t}ByIndices(${M})`), te = s < 2 ? "" : `
  fn set_${t}ByIndices(indices: ${g.indices}, value: ${p}) {
    ${X(`i2o_${t}(indices)`, "value")}
  }`, ae = s < 2 ? "" : (() => {
			return `
  fn set_${t}(${u.map((be) => `d${be}: u32`).join(", ")}, value: ${p}) {
    set_${t}ByIndices(${v(u.map((be) => `d${be}`).join(", "))}, value);
  }`;
		})();
		return {
			impl: () => {
				let M = [], G = !1;
				return b.offsetToIndices && (M.push(S), G = !0), b.indicesToOffset && (M.push(A), G = !0), b.broadcastedIndicesToOffset && (Object.values(F).forEach((be) => M.push(be)), G = !0), b.set && (M.push(ae), G = !0), b.setByIndices && (M.push(te), G = !0), b.get && (M.push(Q), G = !0), b.getByIndices && (M.push(L), G = !0), !i && G && M.unshift(`const ${T} = ${g.indices}(${r.join(",")});`, `const ${x} = ${g.indices}(${k.computeStrides(r).join(",")});`), M.join(`
`);
			},
			type: g,
			offsetToIndices: I,
			...
			set: (...M) => {
				...
				return s === 0 ? X("0u", G) : s === 1 ? X(be[0], G) : (b.set = !0, b.setByIndices = !0, b.indicesToOffset = !0, `set_${t}(${be}, ${G})`);
			},
			setByOffset: X,
			setByIndices: (M, G) => s < 2 ? X(M, G) : (b.setByIndices = !0, b.indicesToOffset = !0, `set_${t}ByIndices(${M}, ${G});`),
			get: Y,
			getByOffset: D,
			getByIndices: Z,
			usage: n,
		...
		mainStart(e = Dt) {
			...
			let i = this.normalizedDispatchGroup[1] === 1 && this.normalizedDispatchGroup[2] === 1;
...
var Wf, Hs, Gf, Hf, Ff, qf, De, Fs, qs, pt = V(() => {
	"use strict";
	J();
	re();
	Ce();
    ...
    output[global_idx] = input[global_idx];
			...
			getRunData: () => {
				...
				return {
					...
					dispatchGroup: { x: Math.ceil(_ / 64 / 4) },
					programUniforms: [{
						type: 12,
						data: Math.ceil(_ / 4)
					}]
		...
		let { newShape: p, newPerm: m } = Ff(t.dims, o), g = k.areEqual(m, [
			2,
			3,
			1
		]), y = k.areEqual(m, [
  ...
  var<workgroup> tile : array<array<${$.type.value}, 17>, ${_}>;
  ${T.mainStart([
					_,
					_,
					1
...
var Kf, jf, Zf, Qf, Yf, Xf, Jf, eh, th, rh, it, Ks, js, Zs, Qs, Ys, Xs, Js, eu, tu, ru, nu = V(() => {
	"use strict";
	J();
	re();
	oe();
	...
	Kf = {
       ...
       `, b = (_) => `
		...
		c.length > 0 && (d = t.compute(De(t.inputs[0], c), {
			inputs: [0],
			outputs: [-1]
		})[0], u = Yf(u.length, d.dims.length));
...
var at, nh, Xr, go, st, oh, ih, ah, sh, uh, dh, lh, ch, ph, mh, ut, ou, iu, au, su, uu, du, lu, cu, pu, mu, Yr = V(() => {
	"use strict";
	J();
	re();
	Ce();
...
`)}
		...
		let r = [];
		return t[1].dims[0] > 0 && t[1].getBigInt64Array().forEach((n) => r.push(Number(n))), ee({
			axes: r,
			keepDims: e.keepDims,
		...
		t.compute(Xr(e, {
			hint: i.cacheKey,
			inputDependencies: ["rank"]
		}, [o[0]], i.noopWithEmptyAxes && i.axes.length === 0 ? nh : n, i.axes, o[0].dataType, i.keepDims, i.noopWithEmptyAxes), { inputs: [0] });
	}, oh = (t, e) => {
		at(t.inputs), st(t, "ReduceLogSum", e, (n, o) => [
		...
		at(t.inputs), st(t, "ReduceL1", e, (n, o) => [
			`var value = ${o.type.storage}(0);`,
			"",
		...
		at(t.inputs), st(t, "ReduceL2", e, (n, o) => [
		...
		at(t.inputs), st(t, "ReduceLogSumExp", e, (n, o) => [
			`var value = ${o.type.storage}(0);`,
			"",
...
`)}`,
		...
		at(t.inputs), st(t, "ReduceProd", e, (n, o) => [
		...
		at(t.inputs), st(t, "ReduceSum", e, (n, o) => [
			`var value = ${o.type.storage}(0);`,
			"",
			`value += ${n.getByIndices("input_indices")};`,
			""
		...
		at(t.inputs), st(t, "ReduceSumSquare", e, (n, o) => [
			`var t = ${o.type.value}(0); var value = ${o.type.value}(0);`,
			"",
			`t = ${n.getByIndices("input_indices")}; value += t * t;`,
			""
...
var best_index : i32 = 0;`,
		...
		t.compute(Xr("ArgMin", {
			hint: e.cacheKey,
			inputDependencies: ["rank"]
		}, [t.inputs[0]], r, [e.axis], 7, e.keepDims), { inputs: [0] });
	}, gu = (t, e) => {
		fu(t.inputs);
		let r = (n, o, i) => {
			let s = [];
...
var fh, yo, hh, gh, bh, Gt, yh, yu, Jr = V(() => {
	"use strict";
	J();
	re();
	jr();
	...
	fh = (t, e) => {
		...
		return {
			...
			hiddenSize: m,
			vHiddenSize: y,
			headSize: Math.floor(m / e.numHeads),
			vHeadSize: Math.floor(y / e.numHeads),
			numHeads: e.numHeads,
			isUnidirectional: !1,
    ...
    `, hh = (t, e, r, n, o, i, s, u) => {
		...
		], y = we(t.dataType, d), b = ze(1, d), _ = ["type"];
  ...
  ${x.mainStart([
    ...
    if (sum == 0) {
      ...
      ${s ? `
		...
		let c = s + i.kvSequenceLength, p = [
			i.batchSize,
			i.numHeads,
			i.sequenceLength,
			c
		], m = t > 1 && n, g = i.kvNumHeads ? i.kvNumHeads : i.numHeads, y = m ? [
			i.batchSize,
			g,
			c,
			i.headSize
		] : void 0, b = i.nReps ? i.nReps : 1, _ = i.scale === 0 ? 1 / Math.sqrt(i.headSize) : i.scale, T = fe(i.headSize), x = i.headSize / T, $ = 12, S = {
			x: Math.ceil(c / $),
			y: Math.ceil(i.sequenceLength / $),
		...
		], E = m && n && k.size(n.dims) > 0, A = ["type", "type"];
		...
		let v = (R) => {
			let N = O("q", e.dataType, e.dims, T), q = [N, O("key", r.dataType, r.dims, T)];
			if (E) {
    ...
    if (global_id.y < uniforms.M && global_id.x < total_sequence_length) {
      ...
      var sum: f32 = ${(() => {
				switch (T) {
					...
					default: throw new Error(`Unsupported components: ${T}`);
				}
			})()};
		...
		let d = i + o.kvSequenceLength, c = o.nReps ? o.nReps : 1, p = o.vHiddenSize * c, m = t > 1 && n, g = o.kvNumHeads ? o.kvNumHeads : o.numHeads, y = m ? [
			o.batchSize,
			g,
			d,
			o.headSize
			...
			x: Math.ceil(o.vHeadSize / _),
			y: Math.ceil(o.sequenceLength / _),
		...
		], $ = m && n && k.size(n.dims) > 0, S = ["type", "type"];
		...
		let E = (A) => {
			let z = O("probs", e.dataType, e.dims), R = [z, O("v", r.dataType, r.dims)];
  ...
  ${A.mainStart([
   ...
   if (m < uniforms.M && n < uniforms.N) {
     ...
     output[outputIdx] = value;
		...
		let S = t.compute(gh(g, e, r, y, x, c, _, p, m), {
			inputs: $,
			outputs: g > 1 ? [-1, 1] : [-1]
		})[0];
		t.compute(hh(S, c.batchSize, c.numHeads, _, c.sequenceLength, T, p, m), {
			inputs: p && m ? [
				S,
				p,
				m
		...
		let I = [S, n];
		b && k.size(b.dims) > 0 && I.push(b), p && I.push(p), m && I.push(m), t.compute(bh(g, S, n, b, c, _, p, m), {
			inputs: I,
			outputs: g > 1 ? [0, 2] : [0]
		});
	}, yh = (t, e) => {
		let r = [
			...
			e.sequenceLength,
			e.headSize
		], n = e.sequenceLength, o = e.inputHiddenSize, i = e.headSize, s = 12, u = {
			x: Math.ceil(e.headSize / s),
			y: Math.ceil(e.sequenceLength / s),
			...
			let g = U("output_q", d[0].dataType, r), y = U("output_k", d[0].dataType, r), b = U("output_v", d[0].dataType, r), _ = O("input", d[0].dataType, d[0].dims), T = O("weight", d[1].dataType, d[1].dims), x = O("bias", d[2].dataType, d[2].dims), $ = _.type.storage;
			return `
  const TILE_SIZE = ${s}u;
  ...
  ${S.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
    ...
    ${T.setByOffset("global_idx", "value")}
		...
		return {
			...
			shaderCache: {
				hint: `${e.epsilon}_${e.format}_${n}_${s}`,
				inputDependencies: c ? [
					"rank",
					"type",
					"type",
		...
		let { inputs: r, outputCount: n } = t, o = vh({
			...e,
			outputCount: n
		});
...
var Sh, ge, xu, Su, Tu, Iu, Cu, Au, Eu, ku, Pu, Th, Ou, zu, Du, Bu, or, Mu, en, Ru, Uu, Nu, Vu, Lu, Wu, Gu, Hu, Fu, qu, Ku, ju, Zu, Qu, Yu, Xu, Ju, ed, _o, wo, td, rd, nd, Ih, Ch, od, tn = V(() => {
	"use strict";
	J();
	re();
	Ce();
	...
	Sh = (t, e, r, n, o, i, s) => {
		...
		let c = O("inputData", r, [u], 4), p = U("outputData", n, [u], 4), m = [{
			name: "vec_size",
			type: "u32"
		}];
		return s && m.push(...s), `
  ...
  ${t.mainStart()}
    ...
    ${p.setByOffset("global_idx", d)}
		...
		let d = [{
			type: 12,
			data: Math.ceil(k.size(t.dims) / 4)
		}];
		return s && d.push(...s), {
			name: e,
			shaderCache: {
			...
			getShaderSource: (c) => Sh(c, k.size(t.dims), t.dataType, i, r, n, u),
			getRunData: (c) => ({
				outputs: [{
					dims: t.dims,
					dataType: i
				}],
				dispatchGroup: { x: Math.ceil(k.size(c[0].dims) / 64 / 4) },
				programUniforms: d
			})
		};
	}, xu = (t) => {
		...
		switch (e.to) {
			...
			case 9:
				r = "vec4<bool>";
				break;
			default: throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${e.to}`);
		}
		...
		t.compute(ge(t.inputs[0], "Clip", (o) => `clamp(${o}, vec4<${n}>(uniforms.min), vec4<${n}>(uniforms.max))`, void 0, r.cacheKey, void 0, [{
...
var kh, Ph, dt, ud, dd, ld, cd, pd, md, fd, hd, gd, bd, yd = V(() => {
	"use strict";
	J();
	re();
	oe();
	kh = (t, e, r, n, o, i, s, u, d, c, p, m) => {
		...
		let u = r.dims.map(Number), d = n.dims.map(Number), c = !k.areEqual(u, d), p = u, m = k.size(u), g = !1, y = !1, b = [c];
		if (c) {
			let _ = ot.calcShape(u, d, !1);
			...
			for (let E = 1; E < p.length; E++) {
				let A = u[u.length - E];
				if (A === d[d.length - E]) I *= A;
				else break;
			}
			I % 4 === 0 ? (y = !0, g = !0) : (T || x || $ || S) && (g = !0);
		} else g = !0;
		return b.push(g), {
			name: t,
			shaderCache: {
				hint: e + b.map((_) => _.toString()).join("_"),
				inputDependencies: ["rank", "rank"]
			},
			getShaderSource: (_) => kh(_, u, d, p, g, c, y, o, r.dataType, n.dataType, s, i),
			getRunData: () => ({
				outputs: [{
					dims: p,
					dataType: s
...
`);
		...
		let o = k.size(r), i = new Array(t.length), s = new Array(t.length), u = 0, d = [], c = [], p = [{
			type: 12,
			data: o
		}];
		for (let _ = 0; _ < t.length; ++_) u += t[_].dims[e], i[_] = u, c.push(t[_].dims.length), s[_] = O(`input${_}`, n, c[_]), d.push("rank"), p.push({
			type: 12,
			data: i[_]
		});
...
var Qe, Ye, Xe, rn, St = V(() => {
	"use strict";
	J();
	re();
	Qe = (t, e, r = "f32") => {
		switch (t.activation) {
			case "Relu": return `value = max(value, ${e}(0.0));`;
			case "Sigmoid": return `value = (${e}(1.0) / (${e}(1.0) + exp(-value)));`;
			case "Clip": return `value = clamp(value, ${e}(${r}(uniforms.clip_min)), ${e}(${r}(uniforms.clip_max)));`;
			case "HardSigmoid": return `value = max(${e}(0.0), min(${e}(1.0), ${r}(uniforms.alpha) * value + ${r}(uniforms.beta)));`;
			case "LeakyRelu": return `value = select(${r}(uniforms.alpha) * value, value, value >= ${e}(0.0));`;
			case "Tanh": return `let e2x = exp(-2.0 * abs(value));
              value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
        `;
			case "": return "";
			default: throw new Error(`Unsupported activation ${t.activation}`);
		}
	}, Ye = (t, e) => {
		...
		let e = t?.activation || "";
		if (e === "HardSigmoid") {
			let [r, n] = t?.activation_params || [.2, .5];
			return {
				activation: e,
				alpha: r,
				beta: n
...
var ke, $d, nn = V(() => {
	...
	ke = (t, e) => {
		switch (t) {
			case 1: return e;
			case 2: return `vec2<${e}>`;
			case 3: return `vec3<${e}>`;
			case 4: return `vec4<${e}>`;
			default: throw new Error(`${t}-component is not supported.`);
		}
	}, $d = (t) => `
...
`;
		...
		let s = t[0].dims, u = t[1].dims, d = s[s.length - 2], c = u[u.length - 1], p = s[s.length - 1], m = fe(c), g = fe(p), y = fe(d), b = k.size(r) / m / y, _ = t.length > 2, T = n ? n.slice(0, -2) : r.slice(0, -2), $ = [
			k.size(T),
			d,
			c
		], S = [
...
var Rh, Uh, vo, Td, Nh, $o, Vh, ar, sn = V(() => {
	"use strict";
	J();
	re();
	oe();
	...
	Rh = (t, e) => t ? `
        ...
        }`, vo = (t, e, r = "f32", n, o = !1, i = 32, s = !1, u = 32) => {
...
fn main(@builtin(local_invocation_id) localId : vec3<u32>,
  ...
  for (var innerRow = 0; innerRow < rowPerThread; innerRow = innerRow + 1) {
      mm_write(batch, globalRow + innerRow, globalCol, acc[innerRow]);
            ...
            `, Nh = (t) => t ? "let ACached = mm_Asub[k][tileRow + innerRow];" : "let ACached = mm_Asub[tileRow + innerRow][k];", $o = (t, e, r = "f32", n, o = !1, i = 32, s = !1, u = 32, d = !1) => {
...
`;
    ...
    `;
		...
		let s = t[0].dims, u = t[1].dims, d = s.slice(0, -2), c = u.slice(0, -2), p = n ? n.slice(0, -2) : r.slice(0, -2), m = k.size(p), g = s[s.length - 2], y = s[s.length - 1], b = u[u.length - 1], _ = y % 4 === 0 && b % 4 === 0, T = g <= 8 ? [
			4,
			1,
			1
		] : [
		...
		let q = (X) => {
			...
			Xe(e, le);
			let Me = we(te.type.tensor), ve = Qe(e, te.type.value, Me), M = Vh(S, F, ve, [
				L,
				Y,
				Z,
				te
...
var Lh, Id, Cd = V(() => {
	...
	Sd();
	sn();
	Lh = (t, e, r, n, o = !1, i, s = 4, u = 4, d = 4, c = "f32") => {
		let p = (N) => {
			switch (N) {
				...
				default: throw new Error(`innerElementSize ${N} is not supported.`);
			}
		}, m = (N) => {
			switch (N) {
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${E}) {
      ...
      setOutputAtCoords(coords[0], coords[1], coords[2], coords[3], value);
		...
		let c = e.format === "NHWC", p = c ? t[0].dims[3] : t[0].dims[1], m = r[0], g = c ? r[2] : r[3], y = c ? r[1] : r[2], b = c ? r[3] : r[1], _ = c && (p % 4 === 0 || p % 3 === 0) && b % 4 === 0, T = c ? b : g * y, x = c ? g * y : b, $ = [
			8,
			8,
			1
		], S = n <= 8 ? [
		...
		let E = _ ? c && p % 4 !== 0 ? 3 : 4 : 1, A = $[1] * S[1], z = $[0] * S[0], v = Math.max($[0] * E, $[1]), R = n % A === 0, N = o % z === 0, F = i % v === 0, q = _ ? [
			E,
			4,
			4
		] : [
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${_ ? `vec4<${te}>` : te}) {
      ...
      }`, ve = [O("x", t[0].dataType, t[0].dims.length, E === 3 ? 1 : E), O("w", t[1].dataType, t[1].dims.length, Z)], M = U("result", t[0].dataType, r.length, Z);
			if (s) {
        ...
        ${_ ? vo(S, $, te, void 0, !c, v) : $o(S, $, te, void 0, !c, v, !1, void 0, u)}`;
		};
		return {
			name: "Conv2DMatMul",
			shaderCache: {
				hint: `${e.cacheKey};${E};${_};${R};${N};${F};${A};${z};${v}`,
				inputDependencies: D
			},
			getRunData: () => ({
				outputs: [{
...
var Wh, Ad, un, Gh, Ed, Hh, kd, Pd, Od = V(() => {
	"use strict";
	J();
	nt();
	re();
	...
	Wh = (t) => {
		...
		return e;
	}, Ad = (t) => typeof t == "number" ? [
		t,
		t,
		t
	] : t, un = (t, e) => e <= 1 ? t : t + (t - 1) * (e - 1), Gh = (t, e, r, n = 1) => {
		let o = un(e, n);
		...
		if (t === "VALID" && (t = 0), typeof t == "number") {
			...
			let b = (m - 1) * o + u - e, _ = (g - 1) * i + d - r, T = (y - 1) * s + c - n, x = Math.floor(b / 2), $ = b - x, S = Math.floor(_ / 2), I = _ - S, E = Math.floor(T / 2);
			p = {
				top: S,
				bottom: I,
				left: E,
	...
	}, kd = (t, e, r, n, o, i = !1, s = "channelsLast") => {
		let u, d, c, p, m;
		if (s === "channelsLast") [u, d, c, p, m] = t;
		else if (s === "channelsFirst") [u, m, d, c, p] = t;
		else throw new Error(`Unknown dataFormat ${s}`);
		let [g, , y, b, _] = e, [T, x, $] = Ad(r), [S, I, E] = Ad(n), A = un(y, S), z = un(b, I), v = un(_, E), { padInfo: R, outDepth: N, outHeight: F, outWidth: q } = Hh(o, d, c, p, T, x, $, A, z, v), X = i ? g * m : g, D = [
			0,
			0,
			0,
			0,
		...
		let x = ($) => {
			...
			Xe(e, S);
			let I = 1, E = we(t[0].dataType), A = O("x", t[0].dataType, t[0].dims.length, g), z = O("W", t[1].dataType, t[1].dims.length, I), v = [A, z], R = U("result", t[0].dataType, r.length, I), N = "";
			if (T) {
...
var zd, Dd, Bd = V(() => {
	...
	St();
	zd = (t, e, r, n) => {
		let o = t.length > 2, i = o ? "value += b[output_channel];" : "", s = t[0].dims, u = t[1].dims, d = e.format === "NHWC", c = d ? r[3] : r[1], p = c / e.group, m = d && p >= 4 ? fe(c) : 1, g = k.size(r) / m, y = [
			{
				type: 12,
				data: g
			},
    ...
    ${x.setByOffset("global_idx", "value")}
		...
		return {
			...
			getRunData: () => ({
				...
				dispatchGroup: { x: Math.ceil(g / 64) },
				programUniforms: y
			}),
			getShaderSource: _
		};
	}, Dd = (t, e, r, n) => {
		let o = t.length > 2, i = fe(r[3]), s = fe(r[2]), u = k.size(r) / i / s, d = [
			t[0].dims[0],
			t[0].dims[1],
			t[0].dims[2],
			t[0].dims[3] / i
		...
		let g = (s - 1) * e.strides[1] + c[1], y = (b) => {
			...
			let E = o ? "value += b[output_channel];" : "", A = [
				{
					name: "output_size",
					type: "u32"
				},
...
var Fh, xo, qh, So, To, Md, Kh, jh, Io, Rd = V(() => {
	"use strict";
	re();
	Cd();
	Od();
	...
	Fh = (t, e, r, n, o, i) => {
		...
		if (t[0].dims[e.format === "NHWC" ? t[0].dims.length - 1 : 1] !== t[1].dims[1] * e.group) throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");
		...
		return {
			...
			format: r,
			dilations: t.dilations,
			group: t.group,
			kernelShape: t.kernel_shape,
			pads: t.pads,
			strides: t.strides,
			wIsConst: t.w_is_const(),
			...e,
		...
		if (r.group !== 1) {
			let A = [e[0]];
			if (o) {
				let v = t.kernelCustomData.wT ?? t.compute(De(e[1], xo), {
					inputs: [1],
		...
		if (_ || p === 1 && m === 1 && r.dilations[0] === 1 && r.dilations[1] === 1 && r.strides[0] === 1 && r.strides[1] === 1 && r.pads[0] === 0 && r.pads[1] === 0) {
			let A = i[0], z, v, R, N = [];
			if (o) {
				let X = t.kernelCustomData.wT ?? t.compute(De(e[1], xo), {
					inputs: [1],
					outputs: [r.wIsConst ? -2 : -1]
				})[0];
		...
		let T = !0, x = t.kernelCustomData.wT ?? t.compute(De(e[1], xo), {
			inputs: [1],
			outputs: [r.wIsConst ? -2 : -1]
		})[0];
		...
		let r = e.format === "NHWC", n = [t.inputs[0].reshape(r ? [
			t.inputs[0].dims[0],
			1,
			t.inputs[0].dims[1],
			t.inputs[0].dims[2]
		...
		let o = [
			...
			0,
			e.pads[1]
		], i = [1].concat(e.strides), s = [1].concat(e.dilations), u = [1].concat(e.kernelShape), d = So({
			...e,
			pads: o,
			strides: i,
			dilations: s,
		...
		let n = r.format === "NHWC" ? "channelsLast" : "channelsFirst", o = So(r, e), i = r.autoPad === "NOTSET" ? r.pads : r.autoPad, s = kd(e[0].dims, e[1].dims, r.strides, r.dilations, i, !1, n);
		t.compute(Pd(e, o, s.outShape, [
			s.filterDepth,
			s.filterHeight,
			s.filterWidth
		], [
...
var Ud, Nd = V(() => {
	...
	oe();
	Ud = (t, e, r) => {
		let n = t.length > 2, o = e.outputShape, i = e.format === "NHWC", s = e.group, u = t[1].dims, d = u[2] / s, c = u[3], p = i ? fe(d) : 1, m = i && c === 1 && d >= 4, g = m ? Math.floor(d / 4) * 4 : Math.floor(d / p) * p, y = d - g, b = i ? fe(c) : 1, _ = i ? c === 1 ? p : b : 1, T = k.size(o) / b, x = [
			Math.ceil(T / 64),
			1,
			1
		];
		ie("verbose", () => `[conv2d_backprop_webgpu] dispatch = ${x}`);
		let $ = ["rank", "rank"], S = [e.strides[0], e.strides[1]], I = [e.kernelShape[i ? 1 : 2], e.kernelShape[i ? 2 : 3]], E = [e.dilations[0], e.dilations[1]], A = [I[0] + (e.dilations[0] <= 1 ? 0 : (e.kernelShape[i ? 1 : 2] - 1) * (e.dilations[0] - 1)), I[1] + (e.dilations[1] <= 1 ? 0 : (e.kernelShape[i ? 2 : 3] - 1) * (e.dilations[1] - 1))], z = [A[0] - 1 - Math.floor((e.pads[0] + e.pads[2]) / 2), A[1] - 1 - Math.floor((e.pads[1] + e.pads[3]) / 2)], v = [
			{
				type: 12,
				data: T
			},
		...
		let R = (N) => {
			...
			], q = we(t[0].dataType), X = i ? 1 : 2, D = i ? 2 : 3, L = i ? 3 : 1, Q = O("W", t[1].dataType, t[1].dims.length, _), Y = O("Dy", t[0].dataType, t[0].dims.length, p), Z = [Y, Q];
...
var Zh, Qh, Yh, Vd, Ld, Xh, Wd, Jh, Gd, Hd = V(() => {
	"use strict";
	Nd();
	St();
	pt();
	Zh = (t, e, r, n, o, i) => (t - 1) * e + r + (n - 1) * o + 1 - i, Qh = (t, e, r, n, o) => {
		...
		let e = rn(t), r = t.format, n = [
			"NOTSET",
			"VALID",
			"SAME_UPPER",
			"SAME_LOWER"
		][typeof t.autoPad > "u" ? 0 : t.autoPad], o = t.dilations, i = t.group ?? 1, s = t.kernelShape, u = t.pads, d = t.strides, c = t.wIsConst();
		return {
			autoPad: n,
			format: r,
			dilations: o,
			group: i,
			kernelShape: s,
			outputPadding: t.outputPadding,
			outputShape: t.outputShape,
			pads: u,
			strides: d,
			wIsConst: c,
			...e,
		...
		if (t[0].dims.length !== t[1].dims.length) throw new Error("filter does not have same dimension as input");
		if (t[0].dims[e.format === "NHWC" ? t[0].dims.length - 1 : 1] !== t[1].dims[0]) throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");
		...
		let o = t.kernelCustomData.wT ?? t.compute(De(e[1], [
			2,
			3,
			0,
			1
		...
		u.length === 0 && (u = [0, 0]), u = [
			...
			0,
			u[1]
		], s = [1].concat(s), i = [1].concat(i), o = [1].concat(o);
		...
		return {
			...
			getRunData: (x) => {
				let $ = d ? [
					...
					n * c,
					o * c
				], S = k.size($), I = m.dims, E = k.sortBasedOnPerm(I, u);
				return {
					outputs: [{
						dims: $,
...
var Co, dn, Yd, og, ig, Ao, Eo, Xd, ag, Jd, el, tl = V(() => {
	"use strict";
	J();
	re();
	Ce();
	...
	Co = "[a-zA-Z]|\\.\\.\\.", dn = "(" + Co + ")+", Yd = "^" + dn + "$", og = "(" + dn + ",)*" + dn, ig = "^" + og + "$", Ao = class {
		...
		constructor(e, r) {
			...
			if (n.split(",").forEach((u, d) => {
				...
				let p = this.processTerm(u, !0, c, d);
				this.lhs.push(p);
		...
		processTerm(e, r, n, o = -1) {
			...
			return c?.forEach((m, g) => {
				if (m === "...") {
					...
					} else if (r) this.hasEllipsis = !0, this.ellipsisDims = u;
		...
		let i = t.map((p) => p.length).map((p, m) => O(`input${m}`, e, p)), s = k.size(n), u = U("output", e, n.length), d = [...r.symbolToInfo.keys()].filter((p) => !r.rhs.symbolToIndices.has(p)), c = (p) => {
			...
			let I = S ? [...m, `let sum = ${i.map((E, A) => E.getByIndices(`input${A}Indices`)).join(" * ")};`] : [
				...m,
				y,
				...T,
				..._,
			...
			return `
            ${p.registerUniforms(d.map((E) => ({
				name: `${Xd(E)}`,
				type: "u32"
			}))).registerUniform("outputSize", "u32").declareVariables(...i, u)}
		...
		return {
			...
			getRunData: () => {
				let p = d.filter((g) => r.symbolToInfo.has(g)).map((g) => ({
					type: 12,
					data: r.symbolToInfo.get(g)?.dimValue || 0
				}));
				p.push({
					type: 12,
					data: s
...
var lg, il, al = V(() => {
	...
	lg = (t) => {
		let e = t[0].dataType, r = k.size(t[0].dims), n = k.size(t[1].dims), o = n % 4 === 0, i = (s) => {
			let u = O("x", e, [1], 4), d = O("bias", e, [1], 4), c = U("y", e, [1], 4), p = [{
      ...
      ${c.setByOffset("global_idx", wo("x_in"))}
		...
		return {
			...
			getRunData: (s) => ({
				...
				dispatchGroup: { x: Math.ceil(r / Dt / 4) }
			})
		};
	}, il = (t) => {
...
var cg, pg, sl, ul, dl = V(() => {
	...
	cg = (t) => {
		...
		s.splice(i, 1, ...n);
		let u = r[i], d = t[0].dataType === 9 ? 4 : 1, c = Math.ceil(k.size(s) / d), p = [
			{
				type: 12,
				data: c
			},
...
var mg, ll, cl, pl = V(() => {
	...
	mg = (t, e, r, n, o, i, s, u, d) => {
		...
		c.push(...W(e.dims, p));
		let m = (g) => {
			let _ = [O("indices_data", e.dataType, e.dims.length), U("input_slice_offsets_data", 12, 1, 1)], T = [
				{
					name: "output_size",
					type: "u32"
				},
  ...
  ${g.mainStart()}
    ...
    input_slice_offsets_data[global_idx] =  base_offset + u32(relative_slice_offset);
		...
		let T = i.slice(0, -1).concat(n.slice(_)), x = k.size(T), $ = [
			{
				type: 12,
				data: x
			},
...
var fg, hg, ml, fl, hl = V(() => {
	...
	fg = (t, e) => {
		...
		if (i.dims.length !== o.dims.length || !o.dims.map((u, d) => d === r ? Math.ceil(u / n) === i.dims[d] : u === i.dims[d]).reduce((u, d) => u && d, !0)) throw new Error("Scales must have the same rank as the input tensor and the dims should match except on gatherAxis.");
		if (s) {
			if (s.dataType !== o.dataType) throw new Error("Zero point must have the same data type as the input tensor.");
			if (s.dims.length !== i.dims.length || !s.dims.map((u, d) => u === i.dims[d]).reduce((u, d) => u && d, !0)) throw new Error("Zero point must have the same rank as the input tensor and the dims should match except on quantizeAxis.");
		}
	}, hg = (t, e) => {
		let r = t[0].dims, n = t[1].dims, o = r.length, i = k.normalizeAxis(e.gatherAxis, o), s = k.normalizeAxis(e.quantizeAxis, o), u = r.slice(0);
		u.splice(i, 1, ...n);
		let d = k.size(u), c = t[2].dataType, m = t[0].dataType === 22, g = [
			{
				type: 12,
				data: d
			},
			...
			...W(...t.map((b, _) => b.dims), u)
		], y = (b) => {
			let _ = O("data", t[0].dataType, t[0].dims.length), T = O("inputIndices", t[1].dataType, t[1].dims.length), x = O("scales", t[2].dataType, t[2].dims.length), $ = t.length > 3 ? O("zeroPoint", t[3].dataType, t[3].dims.length) : void 0, S = U("output", c, u.length), I = [
				_,
				T,
				x
			];
		...
		return {
			...
			shaderCache: {
				hint: `${e.cacheKey};${t.filter((b, _) => _ !== 1).map((b) => b.dims.join("_")).join(";")}`,
				inputDependencies: Array.from({ length: t.length }, (b, _) => "rank")
			},
			getRunData: () => ({
				outputs: [{
					dims: u,
...
var gg, bg, gl, bl, yl = V(() => {
	...
	gg = (t) => {
		...
		let r = t[0].dims, n = t[0].dataType, o = r.length, i = t[1].dims, s = t[1].dataType, u = k.normalizeAxis(e.axis, o), d = r[u], c = i.slice(0), p = k.size(c), m = O("input", n, o), g = O("indicesInput", s, i.length), y = U("output", n, c.length), b = [
			{
				type: 12,
				data: p
			},
...
var yg, _g, _l, wl, vl = V(() => {
	...
	yg = (t) => {
		...
		let d = 16, c = Math.ceil(i / d), p = Math.ceil(o / d);
		k.size(u);
		let y = [
			{
				type: 12,
...
var mt, Tt, Ht, Ft, wg, vg, $g, xg, Sg, Tg, Ig, Cg, $l, xl, Sl = V(() => {
	"use strict";
	J();
	re();
	Ce();
...
`, Ig = (t, e, r) => (() => {
		...
		let r = O("x", t[0].dataType, t[0].dims.length), n = [
			t[1].dims[0],
			t[1].dims[1],
			t[1].dims[2]
		], o = O("grid", t[1].dataType, n.length, 2), i = [
			t[0].dims[0],
			t[0].dims[1],
			t[1].dims[1],
			t[1].dims[2]
		...
		let s = U("output", t[0].dataType, i.length), u = r.type.value, c = [{
			type: 12,
			data: k.size(i)
		}, ...W(t[0].dims, n, i)], p = (m) => `
...
var Ue, kg, Il, Tl, Pg, sr, Cl, ko = V(() => {
	...
	Ue = (t, e) => t.length > e && t[e].dims.length > 0 ? t[e] : void 0, kg = (t, e) => {
		...
		if (s && k.size(s.dims) > 0) {
			S = 8;
			let z = s.dims;
			throw z.length === 1 ? z[0] === p ? S = 1 : z[0] === 3 * p + 2 && (S = 3) : z.length === 2 && z[0] === p && z[1] === $ && (S = 5), S === 8 ? /* @__PURE__ */ new Error("Input \"key_padding_mask\" shape shall be (batch_size) or (batch_size, total_sequence_length)") : /* @__PURE__ */ new Error("Mask not supported");
		}
		let I = !1, E = g;
		...
		return {
			...
			vHiddenSize: E,
			headSize: T,
			vHeadSize: Math.floor(E / e.numHeads),
			numHeads: e.numHeads,
			isUnidirectional: !1,
			pastPresentShareBuffer: !1,
			maskFilterValue: e.maskFilterValue,
			maskType: S,
			scale: e.scale,
			broadcastResPosBias: A,
			passPastInKv: I,
			qkvFormat: x
		};
	}, Il = (t) => ee({ ...t }), Tl = ee({ perm: [
		0,
		2,
		1,
		3
		...
		let u = [
			...
			let g = U("qkv_with_bias", e.dataType, u), y = O("qkv", e.dataType, u), b = O("bias", r.dataType, u);
			return `
  ${m.registerUniforms([
				{
					name: "output_size",
  ...
  ${m.mainStart()}
    ...
    qkv_with_bias[global_idx] = qkv[global_idx] + bias[bias_offset_idx];
		...
		if (s && k.size(s.dims) > 0) {
			...
			return d = Pg(t, i, s, e, n, r * o, u), d = d.reshape([
				e,
				n,
				r,
				o
			]), r === 1 || n === 1 ? d : t.compute(De(d, Tl.perm), {
				inputs: [d],
				outputs: [-1]
			})[0];
...
var Og, zg, Dg, Bg, Po, Al, El, Oo = V(() => {
	...
	Og = (t) => {
		...
		return t[1].dims[0] > 0 && (t[1].getBigInt64Array().forEach((o) => r.push(Number(o))), n = r.length), ee({
			numOutputs: n,
			axis: e.axis,
			splitSizes: r
		});
...
`)}
		...
		let r = t[0].dims, n = k.size(r), o = t[0].dataType, i = k.normalizeAxis(e.axis, r.length), s = new Array(e.numOutputs), u = O("input", o, r.length), d = new Array(e.numOutputs), c = [], p = [], m = 0, g = [{
			type: 12,
			data: n
		}];
		for (let b = 0; b < e.numOutputs; b++) {
			...
			let _ = r.slice();
			_[i] = e.splitSizes[b], p.push(_), s[b] = U(`output${b}`, o, _.length), c.push({
				dims: p[b],
				dataType: t[0].dataType
			});
		}
...
var Mg, ln, kl, zo = V(() => {
	...
	Mg = (t, e) => {
		...
		let { interleaved: r, numHeads: n, rotaryEmbeddingDim: o, scale: i } = e, s = t[0].dims[0], u = k.sizeFromDimension(t[0].dims, 1), d = t[0].dims[t[0].dims.length - 2], c = u / d, p = t[2].dims[1], m = o === 0 ? p * 2 : c / n, g = new Array(s, d, c / m, m - p), y = k.computeStrides(g), b = [
			{
				type: 1,
				data: i
			},
			...
			...W(t[0].dims, t[1].dims, t[2].dims, t[3].dims, t[0].dims)
		], _ = (T) => {
		...
		return {
			...
			shaderCache: {
				hint: ee({ interleaved: r }).cacheKey,
				inputDependencies: [
					"rank",
					"rank",
					"rank",
			...
			getRunData: () => ({
				...
				dispatchGroup: { x: Math.ceil(k.size(g) / Dt) },
				programUniforms: b
			})
		};
	}, kl = (t, e) => {
...
var Rg, Ug, Pl, Ng, Ol, zl = V(() => {
	...
	Rg = (t, e) => {
		...
		if (r.dims.length !== 3 && r.dims.length !== 5) throw new Error("Input query is expected to have 3 or 5 dimensions");
		let d = r.dims[0], c = r.dims[1], p = r.dims.length === 3 ? r.dims[2] : e.numHeads * r.dims[4], m = c, g = 0, y = !n || n.dims.length === 0, b = Math.floor(y ? p / (e.numHeads + 2 * e.kvNumHeads) : p / e.numHeads);
		y && (p = b * e.numHeads);
		...
		let S = 0, I = !1, E = e.kvNumHeads ? b * e.kvNumHeads : p;
		...
		return {
			...
			vHiddenSize: E,
			headSize: b,
			vHeadSize: Math.floor(E / e.kvNumHeads),
			numHeads: e.numHeads,
		...
		return e.dims.length === 3 && r.kvSequenceLength !== 0 && (n = e.reshape([
			...
			o,
			r.headSize
		]), n = t.compute(De(n, Ug.perm), {
			inputs: [n],
			outputs: [-1]
		})[0]), n;
	}, Ng = (t, e, r, n) => {
		let o = 7, i = ["type", "type"], s = [t * e], u = t * e, d = [
			{
				type: 12,
				data: u
			},
			...
			let m = O("seq_lens", r.dataType, r.dims), g = O("total_seq_lens", n.dataType, n.dims), y = U("pos_ids", o, s);
			return `
  ${p.registerUniforms([
				{
					name: "output_size",
  ...
  `;
		...
		if (e.doRotary) {
			let I = t.compute(Ng(r.batchSize, r.sequenceLength, d, c), {
				inputs: [d, c],
				outputs: [-1]
			})[0], E = t.inputs[7], A = t.inputs[8], z = ee({
				interleaved: e.rotaryInterleaved !== 0,
				numHeads: r.numHeads,
...
var Dl, Vg, Lg, Bl, Ml = V(() => {
	...
	Dl = (t, e, r, n, o, i, s, u) => {
		...
		T.push(...W(y, b));
		let x = ($) => {
			let S = O("x", e.dataType, 3, d), z = [
				S,
				O("scale", r.dataType, r.dims),
				O("bias", n.dataType, n.dims),
				U("output", 1, 3, 2)
			];
			return `
  ...
  ${$.mainStart(g)}
    ...
    if (local_idx == 0) {
      ...
      output[workgroup_index] = vec2f(channel_scale, channel_shift);
		...
		let n = e[0].dims, o = n, i = 2, s = n[0], u = n[1], d = k.sizeFromDimension(n, i), c = fe(d), p = k.size(o) / c, m = Dl(t, e[0], e[1], e[2], s, d, u, r.epsilon), g = [
			s,
			u,
			d / c
		], y = [s, u], b = ["type", "none"], _ = (T) => {
			let x = O("x", e[0].dataType, g.length, c), $ = O("scale_shift", 1, y.length, 2), S = U("output", e[0].dataType, g.length, c), I = [
				x,
				$,
				S
			];
  ...
  ${T.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      ${S.setByOffset("global_idx", "value")};
		...
		let n = e[0].dims, o = n, i = n[0], s = n[n.length - 1], u = k.sizeFromDimension(n, 1) / s, d = fe(s), c = k.size(o) / d, p = [{
			type: 12,
			data: u
		}, {
			type: 12,
			data: Math.floor(s / d)
		}], m = ["type", "type"], g = !1, y = [0, n.length - 1];
		for (let x = 0; x < n.length - 2; x++) g = g || n[x + 1] !== 1, y.push(x + 1);
		g = g && n[n.length - 1] !== 1;
		let b = g ? t.compute(De(t.inputs[0], y), {
			inputs: [t.inputs[0]],
			outputs: [-1]
		})[0] : t.inputs[0].reshape(Array.from({ length: n.length }, (x, $) => n[y[$]])), _ = Dl(t, b, e[1], e[2], i, u, s, r.epsilon), T = (x) => {
			let $ = we(e[0].dataType), S = d === 1 ? "vec2f" : `mat${d}x2f`, I = (z) => {
				let v = z === 0 ? "x" : "y", R = d === 1 ? "f32" : `vec${d}f`;
				switch (d) {
					case 1: return `${$}(${R}(scale.${v}))`;
					case 2: return `vec2<${$}>(${R}(scale[0].${v}, scale[1].${v}))`;
					case 4: return `vec4<${$}>(${R}(scale[0].${v}, scale[1].${v}, scale[2].${v}, scale[3].${v}))`;
...
var Hg, Nl, Vl = V(() => {
	...
	Hg = (t) => {
		...
		Hg(t.inputs);
		let e = ot.calcShape(t.inputs[0].dims, t.inputs[1].dims, !0);
		...
		if (r < 8 && n < 8) t.compute(on(t.inputs, { activation: "" }, e));
			...
			if (i !== 1 && o === 1 && s === 1) {
				let u = t.inputs[0].reshape([
					1,
					i,
					n
				]), d = t.inputs[1].reshape([
					1,
					n,
					r
				]), c = [
...
var Fg, qg, Kg, Ll, Wl, Gl = V(() => {
	...
	Fg = (t, e) => {
		...
		let r = t[0].dims, n = r.length, o = r[n - 2], i = e.k, s = e.n, u = r.slice(0, n - 2), d = k.size(u), p = t[1].dims[2] / 4, m = t[0].dataType, g = fe(e.k), y = fe(p), b = fe(s), _ = u.concat([o, s]), T = o > 1 && s / b % 2 === 0 ? 2 : 1, x = k.size(_) / b / T, $ = 64, S = [], I = [
			d,
			o,
			i / g
		], E = k.convertShape(t[1].dims).slice();
		...
		S.push(...W(A));
		let z = (v) => {
			let R = I.length, N = O("a", t[0].dataType, R, g), F = O("b", 12, E.length, y), q = O("scales", t[2].dataType, t[2].dims.length), X = [
				N,
				F,
				q
			], D = t.length === 4 ? O("zero_points", 12, t[3].dims.length) : void 0;
			D && X.push(D);
			let L = A.length, Q = U("output", t[0].dataType, L, b), Y = we(t[0].dataType), Z = (() => {
				switch (g) {
					case 1: return `array<${Y}, 8>`;
					case 2: return `mat4x2<${Y}>`;
					case 4: return `mat2x4<${Y}>`;
					default: throw new Error(`${g}-component is not supported.`);
				}
		...
		return {
			name: "MatMulNBits",
			shaderCache: {
				hint: `${e.blockSize};${e.bits};${g};${y};${b};${T};${$}`,
		...
		let r = t[0].dims, n = r.length, o = r[n - 2], i = e.k, s = e.n, u = r.slice(0, n - 2), d = k.size(u), p = t[1].dims[2] / 4, m = t[0].dataType, g = fe(e.k), y = fe(p), b = u.concat([o, s]), _ = 128, T = s % 8 === 0 ? 8 : s % 4 === 0 ? 4 : 1, x = _ / T, $ = Math.floor(32 / e.bits), S = x * y * $, I = S / g, E = S / e.blockSize, A = k.size(b) / T, z = [], v = [
			d,
			o,
			i / g
		], R = k.convertShape(t[1].dims).slice();
		...
		z.push(...W(N));
		let F = (q) => {
			let X = v.length, D = O("a", t[0].dataType, X, g), L = O("b", 12, R.length, y), Q = O("scales", t[2].dataType, t[2].dims.length), Y = [
				D,
				L,
				Q
			], Z = t.length === 4 ? O("zero_points", 12, t[3].dims.length) : void 0;
			Z && Y.push(Z);
...
var jg, Zg, Qg, Yg, Xg, Jg, eb, tb, Hl, Fl = V(() => {
	"use strict";
	J();
	re();
	oe();
	jg = (t) => {
      ...
      `;
		...
		switch (r.mode) {
			case 0: return Zg(t, e, r.pads.length);
			case 1: return Qg(t, e, r.pads.length);
			case 2: return Yg(t, e, r.pads.length);
			case 3: return Xg(t, e, r.pads.length);
			default: throw new Error("Invalid mode");
		}
	}, eb = (t, e) => {
		let r = k.padShape(t[0].dims.slice(), e.pads), n = t[0].dims, i = [{
			type: 12,
			data: k.size(r)
		}, {
			type: 6,
			data: e.pads
		}], s = t.length >= 3 && t[2].data;
		e.mode === 0 && i.push({
			type: s ? t[2].dataType : 1,
			data: e.value
		}), i.push(...W(t[0].dims, r));
		let u = ["rank"], d = (c) => {
			let p = U("output", t[0].dataType, r.length), m = O("x", t[0].dataType, n.length), g = m.type.value, y = Jg(p, n.length, e), b = [{
				name: "output_size",
				type: "u32"
			}, {
				name: "pads",
		...
		return {
			...
			getRunData: () => ({
				...
				dispatchGroup: { x: Math.ceil(k.size(r) / 64) },
				programUniforms: i
			}),
			getShaderSource: d
		};
...
var cn, ql, Kl, jl, Zl, rb, nb, Ql, Yl, Xl, Jl, ec, tc, rc, nc, oc, ic, ac, sc, uc = V(() => {
	"use strict";
	Le();
	J();
	re();
	...
	cn = (t) => {
		...
		let r = e.format === "NHWC", n = k.size(t), o = k.size(e.kernelShape), i = [{
			type: 12,
			data: n
		}, {
			type: 12,
	...
	}, Zl = (t) => `${t.format};${t.ceilMode};${t.autoPad};${t.kernelShape.length}`, rb = (t) => `${Zl(t)};${t.countIncludePad}`, nb = (t) => `${Zl(t)};${t.storageOrder};${t.dilations}`, Ql = (t) => ({
		format: t.format,
		autoPad: [
			"NOTSET",
			"VALID",
		...
		return {
			...
			getRunData: () => ({
				...
				dispatchGroup: { x: Math.ceil(k.size(i) / 64) },
				programUniforms: p
			}),
			getShaderSource: (T) => jl(T, s, e.dims.length, i.length, o, d, c, 0, m, g, y, b)
		};
	}, Xl = (t) => {
		...
		cn(t.inputs), t.compute(Yl("AveragePool", t.inputs[0], !1, e));
	}, ec = {
		autoPad: "",
		ceilMode: 0,
		countIncludePad: !1,
		...
		cn(t.inputs), t.compute(Yl("GlobalAveragePool", t.inputs[0], !0, e));
	}, nc = (t, e, r, n) => {
		let [o, i] = ql(e, n, r), s = `
      value = max(x_val, value);
    `, u = "", d = O("x", e.dataType, e.dims.length), c = ["rank"], [p, m, g, y, b] = Kl(i, o);
		return p.push(...W(e.dims, i)), {
			name: t,
			shaderCache: {
				hint: `${n.cacheKey};${g};${y};${b}`,
				inputDependencies: c
			...
			getShaderSource: (_) => jl(_, d, e.dims.length, i.length, o, s, u, e.dataType === 10 ? -65504 : -1e5, m, g, y, b)
		};
	}, oc = (t, e) => {
		cn(t.inputs), t.compute(nc("MaxPool", t.inputs[0], !1, e));
	}, ic = (t) => {
		...
		cn(t.inputs), t.compute(nc("GlobalMaxPool", t.inputs[0], !0, e));
	};
});
var ib, ab, dc, lc, cc = V(() => {
	"use strict";
	J();
	re();
	Ce();
	...
	ib = (t, e) => {
		...
		if (t.length > 2) {
			...
			if (!t[1].dims.map((r, n) => r === t[2].dims[n]).reduce((r, n) => r && n, !0)) throw new Error("scale and zero-point inputs must have the same shape.");
		}
		if (e.blockSize > 0) {
			if (t[1].dims.length === 0 || t[1].dims.length === 1 && t[1].dims[0] === 1) throw new Error("blockSize must be set only for block quantization.");
			if (!t[1].dims.map((o, i) => i === e.axis || o === t[0].dims[i]).reduce((o, i) => o && i, !0)) throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");
...
var sb, ub, pc, mc = V(() => {
	...
	oe();
	sb = (t, e, r) => {
		if (t === e || t < e && r < 0 || t > e && r > 0) throw new Error("Range these inputs' contents are invalid.");
	}, ub = (t, e, r, n) => {
		let o = Math.abs(Math.ceil((e - t) / r)), i = [o], s = o, u = [
			{
				type: 12,
				data: s
			},
			...
			let p = U("output", n, i.length), m = p.type.value, g = [
				{
					name: "outputSize",
					type: "u32"
				},
...
var db, lb, fc, hc, gc = V(() => {
	...
	db = (t, e, r, n) => {
		...
		switch (t) {
			case "none": return `${e}=${r};`;
			case "add": return n === "i32" || n === "u32" ? `atomicAdd(&${e}, bitcast<${n}>(${r}));` : `
              ${o}bitcast<${n}>(oldValue) + (${r})${i}`;
			case "max": return n === "i32" || n === "u32" ? `atomicMax(&${e}, bitcast<${n}>(${r}));` : `
                ${o}max(bitcast<f32>(oldValue), (${r}))${i}`;
			case "min": return n === "i32" || n === "u32" ? `atomicMin(&${e}, bitcast<${n}>(${r}));` : `${o}min(bitcast<${n}>(oldValue), (${r}))${i}`;
			case "mul": return `${o}(bitcast<${n}>(oldValue) * (${r}))${i}`;
			default: throw new Error(`Reduction ${t} is not supported.`);
		}
	}, lb = (t, e) => {
		let r = t[0].dims, n = t[1].dims, o = r, i = 1, s = Math.ceil(k.sizeToDimension(n, n.length - 1) / i), u = n[n.length - 1], d = k.sizeFromDimension(r, u), c = [
			{
				type: 12,
				data: s
			},
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${db(e.reduction, "output[data_offset + i]", "value", b.type.value)}
		...
		t.compute(lb(t.inputs, e), {
			inputs: [t.inputs[1], t.inputs[2]],
			outputs: []
		});
	};
});
var cb, pb, mb, bc, fb, hb, gb, bb, yb, _b, wb, vb, yc, $b, xb, Sb, Tb, Ib, _c, wc, vc = V(() => {
	"use strict";
	J();
	re();
	Ce();
...
`, fb = (t, e) => `fn getOriginalCoordinateFromResizedCoordinate(xResized: u32, xScale: f32, lengthResized: u32,
     lengthOriginal: u32, roiStart: f32, roiEnd: f32) -> ${e} { ` + (() => {
        ...
        `;
			...
			case "tf_half_pixel_for_nn": return `return (${e}(xResized) + 0.5) / ${e}(xScale);`;
			...
			case "half_pixel": return `return ((${e}(xResized) + 0.5) / ${e}(xScale)) - 0.5;`;
			default: throw new Error(`Coordinate transform mode ${t} is not supported`);
		}
		...
		let n = (() => {
			switch (r.keepAspectRatioPolicy) {
				case "not_larger": return r.axes.length > 0 ? Math.min(...r.axes.map((i) => e[i]), Number.MAX_VALUE) : Math.min(...e, Number.MAX_VALUE);
				case "not_smaller": return r.axes.length > 0 ? Math.max(...r.axes.map((i) => e[i]), Number.MIN_VALUE) : Math.max(...e, Number.MIN_VALUE);
...
` : "", $b = (t, e, r, n, o) => {
    ...
    fn bilinearInterpolation(output_indices: ${e.type.indices}) -> ${p} {
      ...
      return (x11 * dx2 * dy2 + x12 * dx2 * dy1 + x21 * dx1 * dy2 + x22 * dx1 * dy1);
		...
		let [g, y] = r.length === 2 ? [0, 1] : [2, 3], b = t.type.value, _ = (T) => {
			let x = T === g ? "row" : "col";
			return `
      ...
      ${$.mainStart()}
        ...
        ${(() => {
			switch (e.mode) {
				...
				default: throw Error(`Unsupported resize mode: ${e.mode}`);
			}
		})()};
`}
      }`;
		return {
			name: "Resize",
			shaderCache: {
				hint: `${e.cacheKey}|${r}|${c.length > 0 ? e.mode === "cubic" ? c : c.length : ""}|${o.length > 0 ? o : ""}|${u.length > 0 ? u : ""}|${y}|${e.mode === "nearest" ? s.length : s}`,
				inputDependencies: ["rank"]
			},
			getShaderSource: x,
			getRunData: () => ({
...
var Cb, Ab, $c, xc = V(() => {
	...
	Cb = (t) => {
		...
		let o = e.simplified, i = t[0].dims, s = k.size(i), u = i, d = s, c = i.slice(-1)[0], p = n ? i.slice(0, -1).concat(1) : [], m = !o && t.length > 3, g = t.length > 4, y = n && r > 1, b = n && r > 2, _ = r > 3, T = 64, x = fe(c), $ = [
			{
				type: 12,
				data: d
			},
			...
			let A = [
				...
				O("x", t[0].dataType, t[0].dims, x),
				O("skip", t[1].dataType, t[1].dims, x),
				O("gamma", t[2].dataType, t[2].dims, x)
			];
      ...
      ${E.mainStart([
		...
		return r > 1 && I.push({
			...
			shaderCache: {
				hint: `${x};${y};${b};${_}`,
				inputDependencies: t.map((E, A) => "type")
			},
			getShaderSource: S,
			getRunData: () => ({
				outputs: I,
		...
		Cb(t.inputs);
		let n = [0];
		t.outputCount > 1 && n.push(-3), t.outputCount > 2 && n.push(-3), t.outputCount > 3 && n.push(3), t.compute(Ab(t.inputs, e, t.outputCount, !1), { outputs: n });
	};
});
var Eb, pn, kb, Sc, Pb, Ob, Tc, Ic, Cc = V(() => {
	"use strict";
	J();
	re();
	Ce();
	...
	Eb = (t, e) => {
		...
		if (t.length > 1) {
			...
			return o.length === 0 && (o = [...Array(t[0].dims.length).keys()]), ee({
				starts: r,
				ends: n,
				axes: o
			});
		...
		let p = {
			dims: c,
			dataType: t[0].dataType
		}, m = U("output", t[0].dataType, c.length), g = O("input", t[0].dataType, t[0].dims.length), y = k.size(c), b = [
			{
				name: "outputSize",
				type: "u32"
			},
...
var zb, Db, Ac, Ec, kc = V(() => {
	...
	zb = (t) => {
		...
		u ? (c = Array.from({ length: i }, (z, v) => v), c[s] = i - 1, c[i - 1] = s, d = t.compute(De(r, c), {
			inputs: [r],
			outputs: [-1]
		})[0]) : d = r;
...
var Ub, Nb, Dc, Bc = V(() => {
	...
	Ub = (t, e, r, n, o) => {
		...
		if (i) {
			let c = ot.calcShape(ot.calcShape(e, r, !1), n, !1);
		...
		return {
			...
			getShaderSource: (c) => Ub(c, t, s, i, o),
			getRunData: () => ({
				outputs: [{
					dims: s,
					dataType: o
				}],
				dispatchGroup: { x: Math.ceil(u / 64 / 4) },
				programUniforms: [{
					type: 12,
					data: d
				}, ...W(n, e, r, s)]
...
var Mc, Rc = V(() => {
	...
	Mc = new Map([
		...
		["FusedConv", [Io, To]],
		["Gather", [ul, sl]],
		["GatherElements", [bl, gl]],
		["GatherBlockQuantized", [ml, fl]],
		["GatherND", [ll, cl]],
		["Gelu", [Vu]],
		["Gemm", [wl, _l]],
		["GlobalAveragePool", [rc, tc]],
		["GlobalMaxPool", [sc, ac]],
		["Greater", [fd]],
		["GreaterOrEqual", [gd]],
		["GridSample", [$l, xl]],
		...
		["HardSigmoid", [ju, Ku]],
		["InstanceNormalization", [Bl]],
		["LayerNormalization", [Rl]],
		["LeakyRelu", [Lu, or]],
		["Less", [hd]],
		["LessOrEqual", [bd]],
		["Log", [nd]],
...
var mn, Uc = V(() => {
	...
	mn = class {
		...
		run(e, r, n, o, i) {
			...
			let d = [];
			for (let p of r) d.push({
				binding: d.length,
				resource: { buffer: p.buffer }
			});
			for (let p of n) d.push({
				binding: d.length,
				resource: { buffer: p.buffer }
			});
			i && d.push({
	...
	Vb = (t, e) => {
		...
		for (let n = 0; n < t.length; ++n) {
			...
			switch (e[n]) {
				...
				default: throw new Error(`unsupported input dependency: ${e[n]}`);
			}
		}
		return r.join("|");
	}, Lb = (t, e, r) => {
		...
		async initialize(e, r) {
			...
			let n = [], o = {
				...
				requiredFeatures: n
			}, i = (s) => r.features.has(s) && n.push(s) && !0;
		...
		getComputePassEncoder() {
			if (!this.computePassEncoder) {
				...
				}), this.computePassEncoder = e.beginComputePass(r);
			}
			...
			this.queryType !== "none" && (this.commandEncoder.resolveQuerySet(this.querySet, 0, this.pendingDispatchNumber * 2, this.queryResolveBuffer, 0), e = this.device.createBuffer({
				...
				for (let o = 0; o < r.length / 2; o++) {
					...
					if (this.env.webgpu.profiling?.ondata) this.env.webgpu.profiling.ondata({
						version: 1,
						inputsMetadata: m.map((x) => ({
							dims: x.dims,
							dataType: rt(x.dataType)
						})),
						outputsMetadata: g.map((x) => ({
							dims: x.dims,
							dataType: rt(x.dataType)
						})),
						kernelId: s,
		...
		run(e, r, n, o, i, s) {
			...
			if (p) {
				...
				this.device.queue.writeBuffer(z.buffer, 0, A, 0, S), this.gpuDataManager.release(z.id), b = {
					offset: 0,
					size: S,
					buffer: z.buffer
				};
...
var ur, Mo, Wb, Wc = V(() => {
	...
	ur = class t {
		...
		if (t === "webgpu") {
			...
			await s.initialize(r, n), o("webgpu", [
				s,
				(u) => s.alloc(Number(u)),
				(u) => s.free(u),
				(u, d, c, p = !1) => {
				...
				(u, d, c) => s.createKernel(u, Number(d), c, e.UTF8ToString(e._JsepGetNodeName(Number(d)))),
				(u) => s.releaseKernel(u),
				(u, d, c, p) => {
			...
			o("webnn", [
				...
				async (s, u, d, c, p) => i.ensureTensor(s, u, d, c, p),
				(s, u) => {
					i.uploadTensor(s, u);
				},
				async (s, u) => i.downloadTensor(s, u),
				(s, u) => i.registerMLContext(s, u),
				!!r.trace
			]);
		}
	};
});
var Gb, kr, Pr, Mt, Hb, Gc, er, Or, zr, Hc, Dr, Br, Mr, Qn = V(() => {
	"use strict";
	Le();
	xs();
	Ts();
	...
	Gb = (t, e) => {
		...
		try {
			...
			for (let I of e?.executionProviders ?? []) if ((typeof I == "string" ? I : I.name) === "webnn") {
				if (o.shouldTransferToMLTensor = !1, typeof I != "string") {
					let A = I, z = A?.context, v = A?.gpuDevice, R = A?.deviceType, N = A?.powerPreference;
					z ? o.currentContext = z : v ? o.currentContext = await o.webnnCreateMLContext(v) : o.currentContext = await o.webnnCreateMLContext({
						deviceType: R,
						powerPreference: N
					});
			...
			i = await o._OrtCreateSession(r, n, s), o.webgpuOnCreateSession?.(i), i === 0 && me("Can't create a session."), o.jsepOnCreateSession?.(), o.currentContext && (o.webnnRegisterMLContext(i, o.currentContext), o.currentContext = void 0, o.shouldTransferToMLTensor = !0);
			...
			let S = null;
			return $.some((I) => I === "gpu-buffer" || I === "ml-tensor" || I === "ml-tensor-cpu-output") && (u = o._OrtCreateBinding(i), u === 0 && me("Can't create IO binding."), S = {
				handle: u,
				outputPreferredLocations: $,
				outputPreferredLocationsEncoded: $.map((I) => I === "ml-tensor-cpu-output" ? "ml-tensor" : I).map((I) => to(I))
			}), Mt.set(i, [
				i,
				c,
				p,
		...
		try {
			...
			if (g && !b) {
				...
				wt("wasm bindInputsOutputs"), Mt.set(t, [
					c,
					p,
					m,
					g,
			...
			for (let L = 0; L < T; L++) {
				...
				let Y = s.stackSave(), Z = s.stackAlloc(4 * u), te = !1, ae, le = 0;
				try {
					...
					if (ae === "string") {
						...
						te = !0, X.push([
							...
							{
								gpuBuffer: Te,
								download: s.jsepCreateDownloader(Te, qe, ae),
								dispose: () => {
						...
						if (!Te(t, ae, !1)) throw new Error(`preferredLocation "ml-tensor" for ${ae} output is not supported by current WebNN Context.`);
						let Ne = await he(t, le, M, Ee, !1);
						te = !0, X.push([
							ae,
							Ee,
							{
								mlTensor: Ne,
								download: s.webnnCreateMLTensorDownloader(le, ae),
								dispose: () => {
						...
						let Te = new (Wt(ae))($e);
						new Uint8Array(Te.buffer, Te.byteOffset, Te.byteLength).set(s.HEAPU8.subarray(le, le + Te.byteLength)), X.push([
							ae,
							Ee,
							Te,
							"cpu"
			...
			g && !y && (s._OrtClearBoundOutputs(g.handle) !== 0 && me("Can't clear bound outputs."), Mt.set(t, [
				c,
				p,
				m,
				g,
...
var Rt, Fe, dr, hn, gn, fn, Ro, Uo, qt, Kt, qb, Fc, qc, Kc, jc, Zc, Qc, Yc, No = V(() => {
	"use strict";
	Le();
	Qn();
	vt();
	Ar();
	Rt = () => !!_e.wasm.proxy && typeof document < "u", dr = !1, hn = !1, gn = !1, Uo = /* @__PURE__ */ new Map(), qt = (t, e) => {
		let r = Uo.get(t);
		...
		switch (t.data.type) {
			case "init-wasm":
				dr = !1, t.data.err ? (gn = !0, Ro[1](t.data.err)) : (hn = !0, Ro[0]()), fn && (URL.revokeObjectURL(fn), fn = void 0);
				break;
			case "init-ep":
			case "copy-from":
			case "create":
		...
		if (!hn) {
			...
			if (dr = !0, Rt()) return new Promise((t, e) => {
				Fe?.terminate(), _s().then(([r, n]) => {
					try {
						...
						!o.in.wasm.wasmPaths && (r || Xn) && (o.in.wasm.wasmPaths = { wasm: new URL("../../onnxruntime-web/dist/ort-wasm-simd-threaded.jsep.wasm", import.meta.url).href }), Fe.postMessage(o), fn = r;
					} catch (o) {
						e(o);
					}
				}, e);
			...
			try {
				await Er(_e.wasm), await kr(_e), hn = !0;
			} catch (t) {
				throw gn = !0, t;
			} finally {
				dr = !1;
...
var Xc, Kb, bn, Jc = V(() => {
	...
	Xc = (t, e) => {
		switch (t.location) {
			...
			default: throw new Error(`invalid data location: ${t.location} for ${e()}`);
		}
	}, Kb = (t) => {
		switch (t[3]) {
			case "cpu": return new je(t[0], t[2], t[1]);
			case "gpu-buffer": {
				let e = t[0];
			...
			default: throw new Error(`invalid data location: ${t[3]}`);
		}
	}, bn = class {
...
var tp = {};
Vt(tp, {
	OnnxruntimeWebAssemblyBackend: () => yn,
	initializeFlags: () => ep,
	wasmBackend: () => jb
});
var ep, yn, jb, rp = V(() => {
...
Object.defineProperty(_e.versions, "web", {
	value: as,
	enumerable: !0
});
/**
...
*/
//#endregion
export { _f as InferenceSession, Tr as TRACE, _t as TRACE_EVENT_BEGIN, wt as TRACE_EVENT_END, Ve as TRACE_FUNC_BEGIN, Re as TRACE_FUNC_END, je as Tensor, iT as default, _e as env, kt as registerBackend };
